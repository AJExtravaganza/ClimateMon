...
Satellite::Satellite(): TEMPHYSTERESIS(1), HUMHYSTERESIS(5)
{
...
void Satellite::initialiseDatalogger(int deviceID) {
    ...
    dateTimeStr.appgit statusend((systemDate.month() < 10) ? "0" : "");
...
void Satellite::updateValues(QString datastring) {
